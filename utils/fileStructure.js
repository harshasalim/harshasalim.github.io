...
const fileStructure = [
  ...
  { 
    ...
    children: [
      ...
      { type: 'file', name: 'Review Report 1 - SQL Server Column Store Indexes.pdf', title: 'SQL Server Column Store Indexes', path: 'tech/Review Report 1 - SQL Server Column Store Indexes.pdf', order: 2 },
      { type: 'file', name: 'Review Report 2 - Apache Calcite.pdf', title: 'Apache Calcite', path: 'tech/Review Report 2 - Apache Calcite.pdf', order: 3 },
      { type: 'file', name: 'Review Report 3 - Adaptive Execution.pdf', title: 'Adaptive Execution', path: 'tech/Review Report 3 - Adaptive Execution.pdf', order: 4 },
      { type: 'file', name: 'Review Report 4 - Fast Database Restarts.pdf', title: 'Fast Database Restarts',  path: 'tech/Review Report 4 - Fast Database Restarts.pdf', order: 5 },
      { type: 'file', name: 'Review Report 5 - Managing Cold Data.pdf', title: 'Managing Cold Data', path: 'tech/Review Report 5 - Managing Cold Data.pdf', order: 6 },
      { type: 'file', name: 'Blockchain and Databases.pdf', title: 'Blockchain and Databases', path: 'tech/Blockchain and Databases.pdf', order: 7 },
