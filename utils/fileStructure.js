...
const fileStructure = [
  ...
  { 
    ...
    order: 5,
    children: [
      { type: 'file', name: 'tech-learnings.md', title: 'Tech Learnings', path: 'tech/tech-learnings.md', order: 1 },
      { type: 'file', name: 'Alchemy L&D Sessions.md', title: 'Alchemy L&D Sessions', path: 'tech/Alchemy L&D Sessions.md', order: 2 },
      { type: 'file', name: 'Review Report 1 - SQL Server Column Store Indexes.pdf', title: 'SQL Server Column Store Indexes', path: 'tech/Review Report 1 - SQL Server Column Store Indexes.pdf', order: 3 },
      { type: 'file', name: 'Review Report 2 - Apache Calcite.pdf', title: 'Apache Calcite', path: 'tech/Review Report 2 - Apache Calcite.pdf', order: 4 },
      { type: 'file', name: 'Review Report 3 - Adaptive Execution.pdf', title: 'Adaptive Execution', path: 'tech/Review Report 3 - Adaptive Execution.pdf', order: 5 },
      { type: 'file', name: 'Review Report 4 - Fast Database Restarts.pdf', title: 'Fast Database Restarts',  path: 'tech/Review Report 4 - Fast Database Restarts.pdf', order: 6 },
      { type: 'file', name: 'Review Report 5 - Managing Cold Data.pdf', title: 'Managing Cold Data', path: 'tech/Review Report 5 - Managing Cold Data.pdf', order: 7 },
      { type: 'file', name: 'Blockchain and Databases.pdf', title: 'Blockchain and Databases', path: 'tech/Blockchain and Databases.pdf', order: 8 },
      { type: 'file', name: 'Read Repair Patterns.pdf', title: 'Read Repair Patterns', path: 'tech/Read Repair Patterns.pdf', order: 8 },
      { type: 'file', name: 'OAuth and Auth0.pdf', title: 'OAuth and Auth0', path: 'tech/OAuth and Auth0.pdf', order: 9 },
      { type: 'file', name: 'Intercloud Resource Management.pdf', title: 'Intercloud Resource Management', path: 'tech/Intercloud Resource Management.pdf', order: 10 },
    ]
  },
